...
public interface ItemService {
     ...
     * @throws ru.practicum.shareit.server.validation.NotFoundException   если пользователь с userId не найден
     * @throws ru.practicum.shareit.server.validation.ValidationException если поля name, description или available некорректны
     */
     ...
     * @throws ru.practicum.shareit.server.validation.NotFoundException   если вещь с id не найдена
     * @throws ru.practicum.shareit.server.validation.ValidationException если пользователь не является владельцем
     */
     ...
     * @throws ru.practicum.shareit.server.validation.NotFoundException если вещь не найдена
     */
     ...
     * @throws ru.practicum.shareit.server.validation.NotFoundException если пользователь не найден
     */
